      ...
      <div className="bg-accent py-8 md:px-16 px-4">
        <div className="flex flex-col gap-6 bg-white md:px-8 px-4 py-6 border">
          <div className="flex flex-col gap-4">
            ...
            <p>
              This Privacy Policy describes how NOURISH NATURALS and its
              affiliates (collectively "NOURISH NATURALS", "we", "our", "us")
              collect, use, share, protect or otherwise process your
              information/personal data through our website
              https://www.nourishnaturals.in/ (hereinafter referred to as
          ...
          <div className="flex flex-col gap-4">
            ...
            <p>
              ...
              to be NOURISH NATURALS seeking any personal data like debit/credit
          ...
          <div className="flex flex-col gap-4">
            ...
            <p>
              ...
              an advertisement, posting or other content violates the rights of
              a third party; or protect the rights, property or personal safety
